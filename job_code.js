...
/* ------------------------------------------------------------------ */
/* DUMMY JOB DATA now lives in a separate file: dummy-job-data.js       */
/* It must be loaded BEFORE this script (defines get_dummy_postings,   */
/* get_dummy_job_detail, is_dummy_job, dummy_job_ids).                 */
/* ------------------------------------------------------------------ */
